...
const processAllTestsHandler = require('./handlers/process-all-tests-handler');
routes.get('/process-all-tests', wrap(processAllTestsHandler.index));
routes.post('/process-all-tests', wrap(processAllTestsHandler.create));
